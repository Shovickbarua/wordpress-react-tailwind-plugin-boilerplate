...
TestCrud.save = async data => {
  ...
  const res = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, data).then(response => {
    return response.data;
  }).catch(error => {
    return [];
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TestCrud);
...
/* harmony import */ var _api_TestCrud__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api/TestCrud */ "./src/api/TestCrud.js");
...
const TestComponent = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    id ? state.id = id : "";
    const res = await _api_TestCrud__WEBPACK_IMPORTED_MODULE_1__["default"].save(state);
    if (res) {
      navigate("/list");
    }
  };
...
/***/ "./src/pages/TestComponentList.js":
/*!****************************************!*\
  !*** ./src/pages/TestComponentList.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TestComponentList = () => {
  ...
  const deleteData = async id => {
    ...
    if (confirmMsg) {
      const res = await _api_TestCrud__WEBPACK_IMPORTED_MODULE_1__["default"].delete(id);
      // console.log("res", res);
      if (res) {
        getData();
      }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, "All Datas")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.Link, {
    to: "/",
    className: "bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mb-4"
    ...
    for: "checkbox-all",
    className: "sr-only"
  }, "checkbox"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("th", {
    scope: "col",
    ...
    className: "sr-only"
  }, "Action")))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("tbody", {
    className: "bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
  }, state.map((data, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", {
    ...
    className: "sr-only"
  }, "checkbox"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("td", {
    ...
    className: "ml-2 text-blue-600 dark:text-blue-500 hover:underline text-2xl"
  }, "Delete"))))))))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TestComponentList);
...
/* harmony import */ var _pages_TestComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/TestComponent */ "./src/pages/TestComponent.js");
/* harmony import */ var _pages_TestComponentList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/TestComponentList */ "./src/pages/TestComponentList.js");
...
const router = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.createHashRouter)([{
  ...
  path: "/list",
  element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_pages_TestComponentList__WEBPACK_IMPORTED_MODULE_3__["default"], null)
}]);
react_dom__WEBPACK_IMPORTED_MODULE_1__.createRoot(document.getElementById("test-app")).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.StrictMode, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_4__.RouterProvider, {
  router: router
})));
